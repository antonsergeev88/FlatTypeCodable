...
let package = Package(
    ...
    products: [
        ...
        .library(
            name: "FlatTypeCodable",
            targets: ["FlatTypeCodable"]
        ),
        .executable(
            name: "FlatTypeCodableClient",
            targets: ["FlatTypeCodableClient"]
        ),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .executableTarget(name: "FlatTypeCodableClient", dependencies: ["FlatTypeCodable"]),
